...
public class IndexController {
    ...
    @RequestMapping(value = "/zhenregister")
    ...
    @PostMapping(value="/judge")
     @ResponseBody
    public String xiaoguoTable(@ModelAttribute(value = "user") User user){
            String map = userService.judge(user);
    ...
    @RequestMapping(value = "/zhenlogin")
